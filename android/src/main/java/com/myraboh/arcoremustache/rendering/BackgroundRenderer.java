 ...
 */
package com.myraboh.arcoremustache.rendering;
...
import com.myraboh.arcoremustache.util.Utils;
...
public class BackgroundRenderer {
  ...
  public void createOnGlThread(Context context, int depthTextureId) throws IOException {
    ...
    {
      int vertexShader =
          Utils.loadGLShader(TAG, context, GLES20.GL_VERTEX_SHADER, CAMERA_VERTEX_SHADER_NAME);
      int fragmentShader =
              Utils.loadGLShader(
      ...
      Utils.checkGLError(TAG, "Program creation");

      cameraTextureUniform = GLES20.glGetUniformLocation(cameraProgram, "sTexture");
      Utils.checkGLError(TAG, "Program parameters");
    }
  ...
  private void draw(boolean debugShowDepthMap) {
    ...
    Utils.checkGLError(TAG, "BackgroundRendererDraw");
  }
