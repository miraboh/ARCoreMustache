...
import com.myraboh.arcoremustache.util.Utils.loadGLShader
...
class AugmentedFaceRenderer {
    ...
    private val TAG: String = AugmentedFaceRenderer::class.java.getSimpleName()
    ...
    fun createOnGlThread(context: Context, diffuseTextureAssetName: String) {
        ...
        lightingParametersUniform =
            GLES20.glGetUniformLocation(program, "u_LightningParameters")
